        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="registration-card">
                    ...
                    <!-- Registration Form -->
                    <form method="POST" action="{{ route('store.registration.store') }}" id="storeRegistrationForm" enctype="multipart/form-data" novalidate>
                        @csrf
                        ...
                        <div class="form-section active" id="step1">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" id="store_type" name="store_type" required>
                                    ...
                                    <option value="bookstore">📚 Traditional Book Store</option>
                                    <option value="library">🏛️ Library & Reading Space</option>
                                    <option value="coffee_shop">☕ Coffee Shop with Books</option>
                                    <option value="educational">🎓 Educational & Textbook Store</option>
                                    <option value="online_only">💻 Online Book Store</option>
                                    <option value="home_based">🏠 Home-based Book Business</option>
                                    <option value="religious">🕌 Religious Book Store</option>
                                    <option value="children">🧸 Children's Book Store</option>
                                </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="city" name="city" required>
                                                ...
                                                <option value="addis_ababa">Addis Ababa (አዲስ አበባ)</option>
                                                <option value="dire_dawa">Dire Dawa (ድሬ ዳዋ)</option>
                                                <option value="bahir_dar">Bahir Dar (ባሕር ዳር)</option>
                                                ...
                                                <option value="desse">Dessie (ደሴ)</option>
                                                <option value="harar">Harar (ሐረር)</option>
                                                <option value="adama">Adama (አዳማ)</option>
                                                <option value="jijiga">Jijiga (ጅጅጋ)</option>
                                                <option value="shashamane">Shashamane (ሻሸመኔ)</option>
                                                <option value="arba_minch">Arba Minch (አርባ ምንጭ)</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" 
                                          ...
                                          rows="4"
                                          placeholder="Describe your store in English or Amharic..."></textarea>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="time" 
                                                           ...
                                                           value="08:30" disabled>
                                                </td>
                                                <td>
                                                    <input type="time" 
                                                           class="form-control" 
                                                           name="close_time_sunday"
                                                           value="20:30" disabled>
                                                </td>
                                                <td>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" 
                        ...
                        <div class="navigation-buttons">
                            ...
                            <button type="submit" class=" text-center btn btn-primary" id="submitBtn" style="display: none;">
                                <i class="bi bi-check-circle"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateStep(step) {
        ...
        if (step === 4) {
            ...
            // Optional: only validate password fields when present in DOM
    ...
    function initializeFormValidation() {
        ...
        document.querySelectorAll('[required]').forEach(function(input) {
            input.addEventListener('blur', function() {
                ...
                const hasValue = this.type === 'checkbox' ? this.checked : this.value.trim();
                if (!hasValue && this.hasAttribute('required')) {
        ...
        // Optional real-time password validation (only when fields exist)
