...
@section('title', 'Register Your Book Store - BookHub Ethiopia')
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="registration-card">
                    ...
                    <!-- Registration Form -->
                    <form method="POST" action="{{ route('store.registration.update') }}" id="storeRegistrationForm" enctype="multipart/form-data" novalidate>
                        @csrf
                        @if(!empty($storeId))
                        ...
                        <div class="form-section active" id="step1">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" id="store_type" name="store_type" required>
                                    ...
                                    <option value="bookstore" {% if store.store_type == 'bookstore' %}selected{% endif %}>📚 Traditional Book Store</option>
                                    <option value="library" {% if store.store_type == 'library' %}selected{% endif %}>🏛️ Library & Reading Space</option>
                                    <option value="coffee_shop" {% if store.store_type == 'coffee_shop' %}selected{% endif %}>☕ Coffee Shop with Books</option>
                                    <option value="educational" {% if store.store_type == 'educational' %}selected{% endif %}>🎓 Educational & Textbook Store</option>
                                    <option value="online_only" {% if store.store_type == 'online_only' %}selected{% endif %}>💻 Online Book Store</option>
                                    <option value="home_based" {% if store.store_type == 'home_based' %}selected{% endif %}>🏠 Home-based Book Business</option>
                                    <option value="religious" {% if store.store_type == 'religious' %}selected{% endif %}>🕌 Religious Book Store</option>
                                    <option value="children" {% if store.store_type == 'children' %}selected{% endif %}>🧸 Children's Book Store</option>
                                </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="city" name="city" required>
                                                ...
                                                <option value="addis_ababa" {% if store.city == 'addis_ababa' %}selected{% endif %}>Addis Ababa (አዲስ አበባ)</option>
                                                <option value="dire_dawa" {% if store.city == 'dire_dawa' %}selected{% endif %}>Dire Dawa (ድሬ ዳዋ)</option>
                                                <option value="bahir_dar" {% if store.city == 'bahir_dar' %}selected{% endif %}>Bahir Dar (ባሕር ዳር)</option>
                                                <option value="mekele" {% if store.city == 'mekele' %}selected{% endif %}>Mekele (መቀሌ)</option>
                                                <option value="hawassa" {% if store.city == 'hawassa' %}selected{% endif %}>Hawassa (ሀዋሳ)</option>
                                                <option value="gondar" {% if store.city == 'gondar' %}selected{% endif %}>Gondar (ጎንደር)</option>
                                                <option value="jimma" {% if store.city == 'jimma' %}selected{% endif %}>Jimma (ጅማ)</option>
                                                <option value="desse" {% if store.city == 'desse' %}selected{% endif %}>Dessie (ደሴ)</option>
                                                <option value="harar" {% if store.city == 'harar' %}selected{% endif %}>Harar (ሐረር)</option>
                                                <option value="adama" {% if store.city == 'adama' %}selected{% endif %}>Adama (አዳማ)</option>
                                                <option value="jijiga" {% if store.city == 'jijiga' %}selected{% endif %}>Jijiga (ጅጅጋ)</option>
                                                <option value="shashamane" {% if store.city == 'shashamane' %}selected{% endif %}>Shashamane (ሻሸመኔ)</option>
                                                <option value="arba_minch" {% if store.city == 'arba_minch' %}selected{% endif %}>Arba Minch (አርባ ምንጭ)</option>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="service-cards-grid">
                                    <div class="service-card active" data-service="rental">
                                        ...
                                        <p class="service-description">ማሻሸያ መጽሃፍት</p>
                                    ...
                                    <div class="service-card active" data-service="sale">
                                        ...
                                        <p class="service-description">የመጽሃፍ ሽያጭ</p>
                                    ...
                                    <div class="service-card active" data-service="delivery">
                                        ...
                                        <p class="service-description">ወደ ቤት አቅርቦት</p>
                        ...
                        <div class="form-section" id="step3">
                            ...
                            <div class="terms-card">
                                ...
                                <div class="terms-content">
                                    <h6>ውል እና ሁኔታዎች (Terms & Conditions)</h6>
                                    ...
                                    <p class="mb-0"><strong>አስፈላጊ ማስታወሻ:</strong> BookHub serves as a platform connecting Ethiopian bookstores with readers. All transactions and customer relationships are managed directly between store owners and customers.</p>
                                </div>
                                ...
                                <div class="form-check mt-4">
                                    ...
                                    <label class="form-check-label" for="agree_terms">
                                        ✅ I have read and agree to the Terms & Conditions / ውሎችን አንብቤ እቀበላለሁ
                                    </label>
                        ...
                        <div class="form-section" id="step4">
                            ...
                            <div class="info-card">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="mb-0">
                                            <li>✅ Instant store profile creation</li>
                                            <li>📚 Start adding books immediately</li>
                                            <li>🛒 Accept orders from customers</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <ul class="mb-0">
                                            <li>📱 Manage orders from mobile</li>
                                            <li>📊 View sales analytics</li>
                                            <li>🌟 Get listed in local searches</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const storeData = @json($store ?? null);
