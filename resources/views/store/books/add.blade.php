                ...
                <div class="min-h-screen bg-gray-100 py-10">
                    <div class="max-w-6xl mx-auto px-6">
                        ...
                        <div class="mb-10">
                            ...
                            <p class="text-gray-500 mt-2">Manage your bookstore catalog professionally</p>
                        </div>
                        ...
                        <form method="POST" enctype="multipart/form-data" class="space-y-10" action="{{ route('books.store') }}">
                                ...
                                <div class="space-y-4">
                                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-500 transition cursor-pointer" 
                                        ...
                                        <div id="image_preview_container" class="hidden mb-4">
                                            <img id="image_preview" src="#" alt="Cover preview" class="max-h-48 mx-auto rounded-lg shadow-md">
                                        </div>
                                    ...
                                    <!-- Remove image button -->
                                    <button type="button" onclick="removeImage()" class="text-sm text-red-600 hover:text-red-800 hidden" id="remove_image_btn">
                            ...
                            <div class="sticky bottom-0 border-t border-gray-200 p-6 flex justify-end gap-4 rounded-b-2xl shadow-lg bg-white">
                                ...
                                <button type="submit" name="save_and_add"
                                    class="px-6 py-3 rounded-xl bg-green-600 text-white hover:bg-green-700 shadow-md transition btn btn-warning">
                                    Save & Add Another
                                </button>

                                <button type="submit" name="save_and_close"
